...
1.  **Introduction to the jQuery Effects Library**

-   **Start Files:** Introduction to the jQuery Effects Library
...
4.  **Example 2: Plugin Architecture**

5.  **Example 3: Fading Buttons**

6.  **Example 3: Fade To**

7.  **Example 4: Custom Animations - Part 1**

8.  **Example 4: Custom Animations - Part 2**

9.  **Doing All Animations at Once**

-   **Additional Resources**

-   PDF of Presentation 2.09-NameFile.pdf

10. **Introduction to Tabbed Interface Using jQuery**

-   Start Files: Creating a Tabbed Interface with jQuery --
    > 2.10-StartFiles-FileName.pdf

11. **Styling the Anchor Tags**

12. **Tab Styling and Colors**

13. **Clicking and Fading Tabs**

14. **Whole Script**

-   PDF of Presentation 2.14-NameFile.pdf

15. **Getting the CSS Ready**

-   Start Files: Creating a Tabbed Interface with JavaScript
    > 2.15-StartFiles-FileName.pdf

16. **Making the Tabs Work**

17. **New Tab and Old Tab**

18. **Handling the Switch**
...
2.  **Making the Script General**

3.  **Window Load Function**

4.  **Click Handler for Next Button**

5.  **Next Click Handler with If Statement**

6.  **Challenge Solution**

    -   PDF of Presentation 3.06-FileName.pdf

7.  **Strategy for Version 2**

8.  **Cloning the Unordered List**

9.  **Setting the Left Position**

10. **Adding a Callback Function**

11. **Previous Button Click Handler - Part 1**

12. **Previous Button Click Handler - Part 2**

    -   PDF of Presentation 3.12-FileName.pdf

13. **Slider Using JavaScript**

    -   Start Files: JavaScript Image Sliders 3.13-StartFile.pdf

14. **CSS for Slides and Adding Variables**

15. **Adding More Variables**

16. **Event Handler for the Next Button**

17. **Solution for the Previous Button Challenge**
...
![](images/image004.png){width="3.5in" height="2.1639424759405075in"}
...
DOM, we\'ve already explored **querySelector** and **querySelectorAll,**
...
Also in plain JavaScript, we now have the **addEventListener** method,
...
with event model that jQuery had to offer. The **effects** library is
interesting. The jQuery **effects** library is great, and it\'s really
...
There are two options for plugging in jQuery. The **first** is you can
...
Or, **second**, you can hot link to the library on a CDN or Content
...
**jquery.com**, and I have that website pulled up here, and you can
...
The **npm, Yarn** and **Bower** are all build tools that you might be
...
Javascript that you\'ve seen before with **var** and all this kind of
...
the **compressed** **production** version of jQuery.
...
feed, \[inaudible\] and now they\'re all set to display none. What do we
